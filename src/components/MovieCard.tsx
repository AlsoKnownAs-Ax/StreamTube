...
const MovieCard = ({movie}:{movie:Movie}) => {
  ...
  return (
    <div onClick={handleRoute} className='relative flex-shrink-0 cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg '>
